...
class Vector3 {
    ...
    static dot(other1, other2) {
        // Insert your code here.
        let d = (other2.elements[0] * other1.elements[0]) + (other2.elements[1] * other1.elements[1]) + (other2.elements[2] * other1.elements[2]); // Modify this line to calculate this vector's magnitude.
    ...
    static cross(other1, other2) {
        ...
        var v3x = other1.elements[1] * other2.elements[2] - other1.elements[2] * other2.elements[1];
        var v3y = other1.elements[2] * other2.elements[0] - other1.elements[0] * other2.elements[2];
        var v3z = other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0];
