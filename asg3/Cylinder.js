class Cylinder {
  ...
  render() {
    ...
    for(var angle = 0; angle < 360; angle+=360/8) {
        let angle1 = angle;
        let angle2 = angle+360/8;
        let vec0 = [0.5*Math.cos(angle1*Math.PI/180),0.5,0.5*Math.sin(angle1*Math.PI/180)];
        let vec1 = [0.5*Math.cos(angle1*Math.PI/180),0.0,0.5*Math.sin(angle1*Math.PI/180)];
        let vec2 = [0.5*Math.cos(angle2*Math.PI/180),0.5,0.5*Math.sin(angle2*Math.PI/180)];

        drawTriangle3D([vec0[0], vec0[1], vec0[2], vec1[0], vec1[1], vec1[2], vec2[0], vec2[1], vec2[2]]);

        vec0 = [0.5*Math.cos(angle2*Math.PI/180),0.5,0.5*Math.sin(angle2*Math.PI/180)];
    ...
    for(var angle = 0; angle < 360; angle+=360/8) {
        let angle1 = angle;
        let angle2 = angle+360/8;
        let vec1 = [0.5*Math.cos(angle1*Math.PI/180),0.5,0.5*Math.sin(angle1*Math.PI/180)];
        let vec2 = [0.5*Math.cos(angle2*Math.PI/180),0.5,0.5*Math.sin(angle2*Math.PI/180)];
